<?php
    ...
    $queryRegistro ="INSERT INTO catalogo (nombreCatalogo, descripcion) 
    VALUES (:nombreCatalogoP, :descripcionP) ";

    $resultado=$dbConexion->prepare($queryRegistro);
    $resultado->execute(array(":nombreCatalogoP"=>$nombreCatalogo,                               
                                ":descripcionP"=>$descripcion                               
                                                           
                                ));
    echo "<script>alert('¡Catalogo creado con exito!');</script>";
