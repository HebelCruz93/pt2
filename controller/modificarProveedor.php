<?php
    require 'conexion.php';
     session_start();
    $idProveedorA = $_POST['idProveedor'];    
    ...
    if (empty(trim($razonSocialA))) {
        echo "<script>alert('El campo Razon social no puede contener unicamente espacios');</script>";
    ...
    $resultado->execute(array(":razonSocialP"=>$razonSocialA,                                
                                ...
                                ":idProveedorP"=>$idProveedorA);     
          
    echo "<script>alert('¡Proveedor modificado con exito!');</script>";  
    echo "<script> window.location.href = '../../vista/admin/visualizarProveedor.php'; </script>";
