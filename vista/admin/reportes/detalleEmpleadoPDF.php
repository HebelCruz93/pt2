...
<body>
    ...
    <div class="contenedor">
        ...
        <H3 class="alineacionIzquierda">REPORTE INDIVIDUAL DE EMPLEADO</H3>
        <H3 class="alineacionIzquierda"> ID DE EMPLEADO: <span><?php echo $idEmpleado;	?></span></H3>
        <TABLE BORDER>
            <TR>
                <TH>Nombre</TH>
                <TD class="borde"><?php echo $row['nombreCompleto'];	?></TD>
            <TR>
                <TH>Fecha de entrada</TH>
                <TD class="borde"><?php echo $row['fechaEntrada'];	?></TD>
            <TR>
                <TH>Edad</TH>
                <TD class="borde"><?php echo $row['edad'];	?></TD>
            <TR>
                <TH>Sexo</TH>
                <TD class="borde"><?php echo $row['sexo'];	?></TD>
            <TR>
                <TH>CURP</TH>
                <TD class="borde"><?php echo $row['curp'];	?></TD>
            <TR>
                <TH>RFC</TH>
                <TD class="borde"><?php echo $row['rfc'];	?></TD>
            <TR>
                <TH>NSS</TH>
                <TD class="borde"><?php echo $row['nss'];	?></TD>
            <TR>
                <TH>Teléfono</TH>
            ...
            <TR>
                <TH>ID usuario</TH>
                <TD class="borde"><?php echo $row['idUsuario'];	?></TD>
            <TR>
                <TH>ID puesto</TH>
                <TD class="borde"><?php echo $row['idPuestoEmpleado'];	?></TD>
