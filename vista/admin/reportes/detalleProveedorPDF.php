...
WHERE idProveedor = :idProveedorR";
$resultado=$dbConexion->prepare($query);
$resultado->execute(array(":idProveedorR"=>$idProveedor)); 
...
<body>
    ...
    <div class="contenedor">
        ...
        <H3 class="alineacionIzquierda">REPORTE INDIVIDUAL DE PROVEEDOR</H3>
        <H3 class="alineacionIzquierda"> ID DE PROVEEDOR: <span><?php echo $idProveedor;	?></span></H3>
        <TABLE BORDER>
            <TR>
                <TH>Razón social</TH>
