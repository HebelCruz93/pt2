...
<?php include('../../Componentes/menuAdministracion.php'); ?>
    ...
    <div>
    <a  class="botonGenerarPDF" href="reportes/reporteTickets.php">
                            Generar PDF</a>
    </div>
        ...
        <table >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="sinBorde"><a href="../../controller/cancelarTicket.php?id=<?php echo $row['idTicket'];?>"
                         class="botonEstilo"  > Cancelar</a></th>  
                    <th class="sinBorde"><a href="../../controller/eliminarTicket.php?id=<?php echo $row['idTicket'];?>"
